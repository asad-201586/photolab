...
public class NeonActivity extends BaseActivity implements MenuItemClickLister, OnClickListener {
...
//        tvWingsList.setOnClickListener(this);
    ...
    public void openShareActivity() {
        Intent intent = new Intent(NeonActivity.this, ShareActivity.class);
